...
public class WaterBaseEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (!oceanMaterial.HasProperty("_Fresnel"))
		{
			...
			{
				var fresnelScale = EditorGUILayout.Slider("Intensity", WaterEditorUtility.GetMaterialFloat("_FresnelScale", oceanMaterial), 0.1F, 4.0F);
		...
		{
			var fresnelTex = (Texture)EditorGUILayout.ObjectField("Ramp", WaterEditorUtility.GetMaterialTexture("_Fresnel", oceanMaterial), typeof(Texture), false);
