...
namespace HighlightingSystem
{
	public partial class Highlighter : MonoBehaviour
	{
		...
		private static readonly float constantOnSpeed = 4.5f;

		// Constant highlighting turning off speed (common property for all Highlighters)
		private static readonly float constantOffSpeed = 4f;

		// Default transparency cutoff value (used for shaders without _Cutoff property)
		private static readonly float transparentCutoff = 0.5f;
		...
		/// </summary>
		public void ReinitMaterials() { materialsIsDirty = true; }
		...
		///     Highlighting color.
		/// </param>
		public void OnParams(Color color) { onceColor = color; }
		...
		///     Turn on flashing.
		/// </summary>
		public void FlashingOn() { flashing = true; }
		...
		///     Turn off flashing.
		/// </summary>
		public void FlashingOff() { flashing = false; }

		/// <summary>
		///     Switch flashing mode.
		/// </summary>
		public void FlashingSwitch() { flashing = !flashing; }
		...
		/// </param>
		public void ConstantParams(Color color) { constantColor = color; }
