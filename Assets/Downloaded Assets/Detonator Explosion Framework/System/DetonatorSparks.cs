...
[RequireComponent(typeof(Detonator)), AddComponentMenu("Detonator/Sparks")]
public class DetonatorSparks : DetonatorComponent
{
	private readonly Color _baseColor = Color.white;
	private readonly float _baseDuration = 4f;
//	private float _baseDamping = 0.185f;
	private readonly Vector3 _baseForce = Physics.gravity;
	private readonly float _baseSize = 1f;
	private readonly Vector3 _baseVelocity = new Vector3(400f, 400f, 400f);
