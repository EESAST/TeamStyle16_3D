...
public class DetonatorSmoke : DetonatorComponent
{
	...
	private readonly Color _baseColor = new Color(.5f, .5f, .5f, .5f);
	...
	public void UpdateSmokeA()
	{
		...
		var color1 = new Color(.2f, .2f, .2f, .4f);
		var color2 = new Color(.2f, .2f, .2f, .7f);
		var color3 = new Color(.2f, .2f, .2f, .4f);
